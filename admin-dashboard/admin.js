...
const app = createApp({
  data() {
    return {
      ...
      // 预设选项
      specialtyOptions: ['皮肤管理', '皮肤治疗', '激光提升', '线雕', '填充', '肉毒', '身体填充', '眼部整形', '鼻部整形', '轮廓', '双鄂', '胸部整形', '女性私密', '男性整形', '牙科/眼科', '毛发管理/移植', '脂肪移植/吸', '减肥/塑形', '其他'],
      tagOptions: ['中文服务', '价格优惠', '性价比', '推荐', 'VIP服务', '周日不休息', '免费咨询', '术后护理', '明星医院', '网红打卡', '一对一', '流水线', '专科', '整外'],

      // 服务项目管理
      services: [],
      serviceCategories: ['全部', '整形手术', '皮肤管理', '微整形', '激光提升', '减肥/塑形', '其他'],
      selectedCategory: '全部',
